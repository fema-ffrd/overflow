...
from overflow._util.queue import GridCellInt64Queue as Queue
from overflow._util.raster import GridCellInt64 as GridCell
...
def _label_watersheds_core(
    ...
    Parameters:
    - fdr_filepath (str): The path to the flow direction raster file.
    - drainage_points (dict): A dictionary of drainage points.
    ...
    Returns:
    - dict: A dictionary representing the local graph of watersheds.
